    ...
    def transE(self, cI=20):
        ...
        for cycleIndex in range(cI):
            ...
            if cycleIndex % 100 == 0:
                ...
                print(self.loss)
                self.writeRelationVector("relationVector.txt")
                self.writeEntilyVector("entityVector.txt")
                self.loss = 0
...
if __name__ == '__main__':
    ...
    transE.initialize()
    transE.transE(15000)
    transE.writeRelationVector("relationVector.txt")
    transE.writeEntilyVector("entityVector.txt")